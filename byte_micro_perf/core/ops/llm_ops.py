...
from triton_kernel import moe_softmax_topk

class MoeSoftmaxTopkTritonOp(BasicOp):
    def __init__(self, args_dict, backend, *args, **kwargs):
        super().__init__(args_dict, backend, *args, **kwargs)
    ...
    def prepare(self):
        ...
        # run func
        self._run_func = self.moe_softmax_topk_triton_run

    def moe_softmax_topk_triton_run(self, tensor_mapping):
...
import triton_kernel_moe_gather
from triton_kernel_moe_gather import moe_gather_run

class MoeGatherTritonOp(BasicOp):
    def __init__(self, args_dict, backend, *args, **kwargs):
        super().__init__(args_dict, backend, *args, **kwargs)
